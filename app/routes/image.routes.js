...
router.delete("/product/:id/image/:image_id" , productAuth , imageController.deleteImageById)

router.get("/product/:id/image/:image_id" ,productAuth, imageController.getImageById);
